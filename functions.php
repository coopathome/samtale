...
//		 Add a page number if necessary.
  ...
  function admin_style() {
    echo '<link rel="stylesheet" href="../wp-content/themes/samtale/assets//css/admin.css" type="text/css" media="all" />';
  }
...
function add_to_author_profile( $contactmethods ) {
	...
	$contactmethods['user_role'] = 'Role';
	$contactmethods['user_department'] = 'Store';
